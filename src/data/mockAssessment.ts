export const mockAssessmentResults = {
  assessment: {
    ...
    score: 34,
    max_score: 40,
    description: 'نمونه‌ای از گزارش فوری با داده‌های ساختگی برای تست رابط کاربری.',
    completed_at: '2024-01-04T10:45:00.000Z',
  },
  messages: [
    { role: 'system', content: 'سلام! خوش آمدید به ارزیابی بوتِه.' },
    {
      role: 'assistant',
      content:
        'هدف این ارزیابی بررسی مهارت‌های رهبری شماست. لطفاً به چند سؤال کوتاه پاسخ دهید.',
    },
    {
      role: 'user',
      content: 'آماده‌ام. بفرمایید.',
    },
    {
      role: 'assistant',
      content:
        'عالی! همین حالا بحث را شروع می‌کنیم...',
    },
  ],
};
